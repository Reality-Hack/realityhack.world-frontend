 ...
 */
import type { PatchedAttendeeRSVPRequestParticipationRole } from './patchedAttendeeRSVPRequestParticipationRole';
import type { PatchedAttendeeRSVPRequestShirtSize } from './patchedAttendeeRSVPRequestShirtSize';
 ...
 */
export interface PatchedAttendeeRSVPRequest {
  /** @maxLength 150 */
  first_name?: string;
  /** @maxLength 150 */
  last_name?: string;
  /** @nullable */
  participation_role?: PatchedAttendeeRSVPRequestParticipationRole;
  /** @nullable */
  ...
  /** @nullable */
  us_visa_support_national_identification_document_type?: PatchedAttendeeRSVPRequestUsVisaSupportNationalIdentificationDocumentType;
  /** @nullable */
  us_visa_support_citizenship?: PatchedAttendeeRSVPRequestUsVisaSupportCitizenship;
  /**
   * @minLength 1
   * @maxLength 500
   * @nullable
