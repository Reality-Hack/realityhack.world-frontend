 ...
 */
import type { PatchedSponsorEventEngagementRequestTier } from './patchedSponsorEventEngagementRequestTier';
 ...
 */
export interface PatchedSponsorEventEngagementRequest {
  /** @nullable */
  tier?: PatchedSponsorEventEngagementRequestTier;
  sponsor?: string;
  event?: string;
}
