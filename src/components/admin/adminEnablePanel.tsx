import {
  default as HardwareIcon,
  default as ToolsIcon
...
const AdminOverlay: React.FC<AdminOverlayProps> = ({ onClose }) => {
  ...
  return (
    <div
      ref={overlayRef}
      className="flex flex-col w-full h-full mb-2 rounded-lg border border-1 border-gray-200 overflow-y-auto pb-2"
    >
      ...
      <div
        className="w-full mt-auto p-2 rounded-lg border border-1 border-gray-200 hover:bg-gray-700 hover:text-white hover:cursor-pointer text-center shadow-lg my-1"
        onClick={onClose}
      >
        Close
      </div>
...
function FeatureFlagComponent({
  ...
  return (
    <div className="flex flex-row p-2 border-x-0 border-y-2 border-gray-200">
      ...
      <button
        className="px-2 rounded-lg ml-auto border border-1 border-gray-200 hover:bg-gray-700 hover:cursor-pointer hover:text-white"
        onClick={toggleBox}
      >
