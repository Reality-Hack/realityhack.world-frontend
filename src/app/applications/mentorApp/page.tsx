...
const MentorApp: NextPage = ({}: any) => {
  ...
  const CustomTab1 = () => (
    <div className="text-sm px-4">
      ...
      <div>
        You will receive a confirmation email when you complete the application
        submission.
      </div>
  ...
  const CustomTab3 = () => <div className="text-lg">Custom Tab 3 Content</div>;

  const CustomTab4 = () => <div className="text-lg">Custom Tab 4 Content</div>;

  const CustomTab5 = () => <div className="text-lg">Custom Tab 5 Content</div>;

  const CustomTab6 = () => <div className="text-lg">Custom Tab 6 Content</div>;

  const CustomTab7 = () => <div className="text-lg">Custom Tab 7 Content</div>;
  ...
  return <AnyApp key="1" tabs={tabs} AppType="Mentor" />;
};
